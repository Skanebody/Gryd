...
- [ ] Carte : appliquer le traitement « couche de guerre » (largeur/alpha) au fond `color` (Voyager), pas seulement satellite — cohérence des 3 fonds — S
...
- [ ] Onboarding : remonter Apple Santé / import GPX AVANT Strava dans l'étape sync (l'API Strava est passée payante) — friction — S
