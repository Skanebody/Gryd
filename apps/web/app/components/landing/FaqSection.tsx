 ...
 * 8 semaines, seuils mode Guerre, pionnier, Verify) —
  ...
  fr: {
    items: [
      ...
      },
      {
        ...
        a: `Tu reçois une notification et un raccourci revanche : re-cours la zone pour la reprendre — une zone volée rapporte d’ailleurs ${POINTS_STOLEN_HEX} points contre ${POINTS_NEUTRAL_HEX} pour une neutre. Tes captures fraîches restent involables ${HEX_LOCK_HOURS} h : défendre, c’est y retourner.`,
      },
      {
  ...
  en: {
    items: [
      ...
      },
      {
        ...
        a: `You get a notification and a revenge shortcut: re-run the zone to take it back — a stolen zone is worth ${POINTS_STOLEN_HEX} points versus ${POINTS_NEUTRAL_HEX} for a neutral one. Your fresh captures stay unstealable for ${HEX_LOCK_HOURS} h: defending means going back out.`,
      },
      {
