...
const fr = {
  ...
  pricing: {
    ...
    title: 'Le jeu est gratuit. Et complet.',
    sub: 'Territoire, points, victoire, crew : 100 % gratuits. Le seul abonnement n’ajoute que du confort, de l’info et du statut — jamais de la protection ni du terrain.',
    freeTitle: 'Gratuit, pour toujours',
    freeItems: ['Tout le territoire', 'Tous les points', 'La victoire de saison', 'Ton crew au complet'],
    freeNote: 'Aucun achat ne donne de zones, de points, de vitesse ni de protection. Le jeu complet se joue sans payer un centime.',
    monthly: 'Mensuel',
    annual: 'Annuel',
    save: 'Économise',
    perMonth: '/mois',
...
const en: Dict = {
  ...
  pricing: {
    ...
    title: 'The game is free. And complete.',
    sub: 'Territory, points, the win, your crew: 100% free. The single subscription only adds comfort, intel and status — never protection or ground.',
    freeTitle: 'Free, forever',
    freeItems: ['All the territory', 'All the points', 'The season win', 'Your full crew'],
    freeNote: 'No purchase grants zones, points, speed or protection. The complete game plays without paying a cent.',
    monthly: 'Monthly',
    annual: 'Yearly',
    save: 'Save',
    perMonth: '/month',
