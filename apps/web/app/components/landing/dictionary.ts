...
const fr = {
  ...
  connect: {
    kicker: 'Ton matériel',
    title: 'Branche. Cours. Capture.',
    sub: 'Strava et Apple Health importent. Seul le GPS vérifié capture.',
...
const en: Dict = {
  ...
  connect: {
    kicker: 'Your gear',
    title: 'Plug in. Run. Capture.',
    sub: 'Strava and Apple Health import. Only verified GPS captures.',
