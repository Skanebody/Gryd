...
export const C = defineCatalog({
  ...
  guestNote: {
    fr: 'Tes sorties restent privées sur cet appareil. Tu pourras les rattacher à ton compte plus tard.',
    en: 'Your activities stay private on this device. You can link them to your account later.',
    es: 'Tus actividades siguen privadas en este dispositivo. Podrás vincularlas a tu cuenta más tarde.',
    de: 'Deine Aktivitäten bleiben privat auf diesem Gerät. Du kannst sie später deinem Konto zuordnen.',
    pt: 'Suas atividades ficam privadas neste aparelho. Você poderá vinculá-las à sua conta depois.',
  },
  ageAccountOnly: {
    fr: 'Cette vérification protège la création du compte. Tu peux toujours courir sans compte.',
    en: 'This check protects account creation. You can still run without an account.',
    es: 'Esta comprobación protege la creación de la cuenta. Aún puedes correr sin cuenta.',
    de: 'Diese Prüfung schützt die Kontoerstellung. Du kannst weiterhin ohne Konto laufen.',
    pt: 'Esta verificação protege a criação da conta. Você ainda pode correr sem conta.',
  },
  callbackChecking: {
  ...
  callbackFailed: {
    fr: 'Ce retour de connexion n’est plus valide. Demande un nouveau lien.',
    en: 'This sign-in return is no longer valid. Request a new link.',
    es: 'Este acceso ya no es válido. Solicita un enlace nuevo.',
    de: 'Diese Anmeldung ist nicht mehr gültig. Fordere einen neuen Link an.',
    pt: 'Este acesso não é mais válido. Peça um novo link.',
  },
  ...
  gpxNeedsAccount: {
    fr: 'Connecte-toi pour importer une sortie',
    en: 'Sign in to import an activity',
    es: 'Inicia sesión para enviar una carrera',
    de: 'Melde dich an, um einen Lauf zu senden',
    pt: 'Entre para enviar uma corrida',
  },
  /** Import conservé dans le journal privé, sans promesse de capture. */
  gpxSent: {
    fr: 'Sortie importée dans ton journal privé',
    en: 'Activity imported into your private journal',
    es: 'Actividad importada en tu diario privado',
    de: 'Aktivität in dein privates Tagebuch importiert',
  ...
  gpxRejected: {
    fr: 'Cette sortie n’a pas pu être validée',
    en: 'This activity could not be validated',
