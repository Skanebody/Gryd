...
export const C = defineCatalog({
  ...
  creditsZonesBody: {
    fr: 'Les contours de Paris et de Lille — ceux qui décident si une course capture — viennent du découpage administratif officiel français.',
    en: 'The Paris and Lille boundaries — the ones deciding whether a run captures — come from the official French administrative dataset.',
    es: 'Los contornos de París y Lille —los que deciden si una carrera captura— vienen del catastro administrativo oficial francés.',
    de: 'Die Grenzen von Paris und Lille — sie entscheiden über Eroberungen — stammen aus dem offiziellen französischen Verwaltungsdatensatz.',
    pt: 'Os contornos de Paris e Lille — os que decidem se uma corrida captura — vêm do recorte administrativo oficial francês.',
  },
  creditsZonesAttribution: {
    fr: 'Contours administratifs : geo.api.gouv.fr (Etalab) — Licence Ouverte 2.0',
    en: 'Administrative boundaries: geo.api.gouv.fr (Etalab) — Open Licence 2.0',
    es: 'Contornos administrativos: geo.api.gouv.fr (Etalab) — Licence Ouverte 2.0',
    de: 'Verwaltungsgrenzen: geo.api.gouv.fr (Etalab) — Licence Ouverte 2.0',
    pt: 'Contornos administrativos: geo.api.gouv.fr (Etalab) — Licence Ouverte 2.0',
  },
  creditsMapHeading: {
    fr: 'Fonds de carte',
    en: 'Map backgrounds',
