...
export const C = defineCatalog({
  ...
  rivalOwnerHint: {
    fr: 'Identité masquée — on n’invente pas un nom',
    en: 'Identity hidden — we don’t invent a name',
    es: 'Identidad oculta — no inventamos un nombre',
    de: 'Identität verborgen — kein erfundener Name',
    pt: 'Identidade oculta — sem nome inventado',
  },
  rivalMetricSurface: {
    fr: 'surface',
    en: 'area',
