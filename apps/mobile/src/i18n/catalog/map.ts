...
export const C = defineCatalog({
  ...
  // ── E02 Home Map premier usage — sheet PREMIÈRE MISSION ──
  firstMissionEyebrow: {
    fr: 'PREMIÈRE MISSION',
    en: 'FIRST MISSION',
    es: 'PRIMERA MISIÓN',
  ...
  firstMissionLine: {
    ...
    de: 'Schließ eine Schleife um deine Straße.',
    pt: 'Feche um loop ao redor da sua rua.',
  },
  firstMissionLineBike: {
    fr: 'Territoires et classements séparés du Run.',
    en: 'Territories and leaderboards stay separate from Run.',
    es: 'Territorios y rankings separados del Run.',
    de: 'Gebiete und Rankings getrennt vom Run.',
    pt: 'Territórios e rankings separados do Run.',
  },
  activeTerritoryEyebrowSolo: {
    fr: 'VOTRE TERRITOIRE · SOLO',
    en: 'YOUR TERRITORY · SOLO',
    es: 'TU TERRITORIO · SOLO',
    de: 'DEIN GEBIET · SOLO',
    pt: 'SEU TERRITÓRIO · SOLO',
  },
  activeTerritoryEyebrowCrew: {
    fr: 'VOTRE TERRITOIRE · CREW',
    en: 'YOUR TERRITORY · CREW',
    es: 'TU TERRITORIO · CREW',
    de: 'DEIN GEBIET · CREW',
    pt: 'SEU TERRITÓRIO · CREW',
  },
  firstMissionSeeDetail: {
    fr: 'Voir le détail ›',
    en: 'See details ›',
    es: 'Ver detalle ›',
    de: 'Details ansehen ›',
  ...
  // ── E04 Territoire rival — décision REPRENDRE (données réelles seulement) ──
  rivalEyebrow: {
    fr: 'REPRISE',
    en: 'TAKE BACK',
    es: 'RECUPERAR',
  ...
  rivalOwnerAnon: {
    fr: 'Un coureur rival',
    en: 'A rival runner',
    es: 'Un corredor rival',
    de: 'Ein Rivalenläufer',
    pt: 'Um corredor rival',
  },
  rivalOwnerHint: {
    fr: 'Identité non partagée',
    en: 'Identity not shared',
    es: 'Identidad no compartida',
    de: 'Identität nicht geteilt',
    pt: 'Identidade não compartilhada',
  },
  rivalMetricSurface: {
    fr: 'surface',
    en: 'area',
  ...
  rivalCtaA11y: {
    fr: 'Reprendre — lancer la course de conquête',
    en: 'Take back — start the conquest run',
    es: 'Recuperar — iniciar la carrera de conquista',
    de: 'Zurückholen — Eroberungslauf starten',
    pt: 'Retomar — começar a corrida de conquista',
  },
  rivalPlanLater: {
