...
// Source : packages/engine/src/validation.ts (drift testé côté Deno).
 ...
 */
import { type Activity, activityRules, DEFAULT_ACTIVITY } from '@klaim/shared';
import type { RejectReason, RunPoint } from '@klaim/shared';
