...
export default function Discovery2026Screen() {
  ...
  return <View style={s.root}>
    {welcome ? <><Image source={brandImagery.movement.source} accessibilityLabel={fr ? brandImagery.movement.fr : brandImagery.movement.en} resizeMode="cover" style={s.photo} /><Svg pointerEvents="none" accessible={false} width="100%" height="100%" style={StyleSheet.absoluteFill}><Defs><LinearGradient id="discoveryShade" x1="0" y1="0" x2="0" y2="1"><Stop offset="0" stopColor={c.carbon} stopOpacity={0.3} /><Stop offset="0.35" stopColor={c.carbon} stopOpacity={0} /><Stop offset="0.58" stopColor={c.carbon} /><Stop offset="1" stopColor={c.carbon} /></LinearGradient></Defs><Rect width="100%" height="100%" fill="url(#discoveryShade)" /></Svg></> : null}
