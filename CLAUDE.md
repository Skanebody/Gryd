...
## Backend
Projet Supabase `gryd` (`sydwxwwirinjoheeodcg`) — migrations appliquées jusqu'à `0128` en prod
(10/09/2026 : 0118-0128 = refonte 2026 de Codex, renumérotées ; `ingest_run`, `progression_2026`,
`sync_gryd_plus_access_2026`, `rc_webhook` redéployées). Codex pousse sur le même projet : toujours
