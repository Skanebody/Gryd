...
| **E37** | Partage terminé | absent | P2 | S | `apps/mobile/app/partage.tsx (ShareToast)` | Le seul feedback de fin est un toast texte auto-dismiss, sans aucune action proposée. Pas de retour au résultat post-partage (le lien ← Résultat n'exi |
