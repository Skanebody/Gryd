...
| E02 | Home Map — nouveau joueur | 🔄 header ✓ (`ac8bd22`), RUN rond ✓ (`4fe4292`) | Sheet TIRABLE « PREMIÈRE MISSION » (900 m·6 min réels via suggestion de boucle, sinon vide) ; boucle 900 m pointillée + pin joueur ; FABs en CAPSULE ; nav Carte/Crew/**Profil** ; RUN morph rond↔ancré-sheet |
