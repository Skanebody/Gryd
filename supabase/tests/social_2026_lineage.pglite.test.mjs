...
// storage schema and 0118's scalar runs.ruleset_version column are fixtures;
// no HTTP gateway or execution of the PostGIS 0118 migration is claimed here.
...
try{
 ...
 await db.exec(readFileSync(new URL('0124_refonte_2026_social.sql',dir),'utf8'));
 ...
 console.log(`ok - actual 0124 applies after ${files.length} existing migrations; old outing APIs exclude cancelled events`);
